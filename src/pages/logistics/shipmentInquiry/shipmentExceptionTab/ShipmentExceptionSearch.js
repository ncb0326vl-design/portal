...
import { MAX_QUERY_DAYS, SHIPMENT_EXCEPTION_REASON } from 'Constants/defaultValues'
...
const validationSchema = Yup.object({
  ...
  shipDateTo: Yup.string()
    ...
    .test('after-start', '查詢迄日不可早於起日', function checkOrder(value) {
      ...
      return (
        dayjs(value, DATE_FORMAT).isSame(dayjs(shipDateFrom, DATE_FORMAT)) ||
...
const ShipmentExceptionSearch = ({ onSearch }) => {
  ...
  return (
    <form onSubmit={formik.handleSubmit}>
      ...
      <SelectionField
        ...
        label="異常原因"
        options={SHIPMENT_EXCEPTION_REASON}
      />
...
export default ShipmentExceptionSearch
